...
namespace SimpleEshop.Application.Services
{
    public class UserService : IUserService
    {
        private List<User> users = new List<User>
        {
            ...
            new User{Id=2, UserName="kemal", Password="123", Email="a@b.com", FullName="Kemal Yalçın" , Role="editor"},
            new User{Id=3, UserName="sinem", Password="123", Email="a@b.com", FullName="Sinem  Odabaş" , Role="client"}
        };
